...
#if !defined(LINT)
static char rscid[] =
"$Id: cpc_args.c,v 1.1 2013/08/12 21:15:03 zma0472 Exp $";
#endif /*  !defined(LINT)  */

char *tstpath = CPC_DEFAULT_TSTPATH;
char *pidpath = CPC_DEFAULT_PIDPATH;
char *errpath = CPC_DEFAULT_ERRPATH;
char *logpath = CPC_DEFAULT_LOGPATH;
